...
$unexpected = @($files | Where-Object { $_.Name -notin @('WindowPosition.exe', 'settings.cfg', 'WindowPosition.log', 'WindowPosition.log.1') -and $_.Name -notlike 'settings.cfg.corrupt.*' })
